...
/**
 * Clase lista de cursos. Permite gestionar la lista añadiendo, eliminando o
 * bien modificando la lista.
 *
...
public class Lista_Cursos implements Interfaz_Listas<Curso> {
    ...
    /**
     * Devuelve el objeto Curso en la posicion indicada por parametro. Si no lo
